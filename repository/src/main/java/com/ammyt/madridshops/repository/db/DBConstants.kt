...
internal object DBConstants {
    ...
    val ALL_COLUMNS_SHOP = arrayOf(KEY_SHOP_DATABASE_ID, KEY_SHOP_ID_JSON, KEY_SHOP_NAME, KEY_SHOP_IMAGE_URL,
            KEY_SHOP_LOGO_IMAGE_URL, KEY_SHOP_ADDRESS, KEY_SHOP_TELEPHONE, KEY_SHOP_URL,
            KEY_SHOP_DESCRIPTION_EN, KEY_SHOP_DESCRIPTION_ES, KEY_SHOP_LATITUDE, KEY_SHOP_LONGITUDE,
            KEY_SHOP_OPENING_HOURS_EN, KEY_SHOP_OPENING_HOURS_ES)
    ...
    val ALL_COLUMNS_ACTIVITY = arrayOf(KEY_ACTIVITY_DATABASE_ID, KEY_ACTIVITY_ID_JSON, KEY_ACTIVITY_NAME, KEY_ACTIVITY_IMAGE_URL,
            KEY_ACTIVITY_LOGO_IMAGE_URL, KEY_ACTIVITY_ADDRESS, KEY_ACTIVITY_TELEPHONE, KEY_ACTIVITY_URL,
            KEY_ACTIVITY_DESCRIPTION_EN, KEY_ACTIVITY_DESCRIPTION_ES, KEY_ACTIVITY_LATITUDE, KEY_ACTIVITY_LONGITUDE,
            KEY_ACTIVITY_OPENING_HOURS_EN, KEY_ACTIVITY_OPENING_HOURS_ES)
